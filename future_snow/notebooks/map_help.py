...
def generate_spc_legend(ax, title, bounds, colors, size=13, fontsize=13):
    '''
    ...
    cax = ax.legend(handles=legend_handles, framealpha=1, title=title, prop={'size': size}, ncol=2, loc=4)
    cax.set_zorder(10)
    cax.get_title().set_fontsize(str(fontsize))
